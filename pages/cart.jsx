...
<Image src={product.img} layout="fill" alt="captain cauliflower" objectFit='cover'/>
                            </div>
                        </td>
                        <td>
            ...
            <div className={styles.right}>
                ...
                onClick={() => setCash(true)}>CASH ON DELIVERY </button>
                        <PayPalScriptProvider
                options={{
                    "client-id":"AbMX4uj-iF41l6MkvAM27HZFrVTCNarL0Y5_MeX0ZPeYBOKjD1SaSQRSxUd1VRkLFKVErqY5dJFyatRu",
                    components: "buttons",
                    currency:  "GBP",
